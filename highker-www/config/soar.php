...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'path' => env('SOAR_PATH','/Users/dirty/Applications/web/highker/highker-www/vendor/bin/soar'),
    ...
    */
    'options' => [
         ...
         */
        '-test-dsn' => [
            'host' => env('SOAR_TEST_DB_HOST', config('database.connections.mysql.host', '127.0.0.1')),
         ...
         * 忽略规则
         */
        '-ignore-rules' => 'COL.001,COL.011,ARG.005,ARG.006,FUN.001,RES.002,SUB.001,EXP.000',
