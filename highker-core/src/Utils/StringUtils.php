...
class StringUtils
{
     ...
     * @return mixed|string
     */
    public static function strFirstToPinyin($str, bool $upperCase = true)
    {
        $str = Pinyin::abbr($str);
        [$str] = str_split($str);

        return $upperCase ? ucfirst($str) : $str;
    }

    public static function shortenNumber($num, $length)
    {
        // 使用 MD5 哈希函数生成哈希值
        $hash = md5($num);
        // 截取哈希值的前 $length 个字符
    ...
    public static function getSigns($month, $day)
    {
    ...
    public static function generateNickname()
    {
         ...
         * 随机昵称 形容词.
         */
        $adjective = ['迷你的', '鲜艳的', '飞快的', '真实的', '清新的', '幸福的', '可耐的', '快乐的', '冷静的', '醉熏的', '潇洒的', '糊涂的', '积极的', '冷酷的', '深情的', '粗暴的',
         ...
         * 名词.
         */
        $noun = ['嚓茶', '皮皮虾', '皮卡丘', '马里奥', '小霸王', '凉面', '便当', '毛豆', '花生', '可乐', '灯泡', '哈密瓜', '野狼', '背包', '眼神', '缘分', '雪碧', '人生', '牛排',
         ...
         * @return string
         */
        $adjectiveCount = rand(0, count($adjective) - 1);
        $nounCount = rand(0, count($noun) - 1);

        return $adjective[$adjectiveCount].$noun[$nounCount];
    }
}
