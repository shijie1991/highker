            ...
            @foreach($grid->rows() as $row)
                <li>
                    ...
                    <div class="mailbox-attachment-info">
                        ...
                        <div class="d-flex justify-content-between item">
                            <span
                                class="mailbox-attachment-name">{!! $grid->columns()->get('feed.id')->getLabel() !!}</span> {!! $row->column('feed.id') !!}
                        </div>

                        <div class="d-flex justify-content-between item">
                            <span
                                class="mailbox-attachment-name">{!! $grid->columns()->get('user')->getLabel() !!}</span> {!! $row->column('user') !!}
                        </div>

                        <div class="d-flex justify-content-between item">
                            <span
                                class="mailbox-attachment-name">{!! $grid->columns()->get('action')->getLabel() !!}</span> {!! $row->column('action') !!}
                        </div>
